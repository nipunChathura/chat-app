...
import static lk.ijse.chat.controller.LoginController.users;

public class ChatPageController extends Thread implements Initializable {
...
//        box.getChildren().add(emojisLabel);
        ...
        clientName.setText(LoginController.username);
        connectSocket();
    }
    ...
    public void run() {
        try {
            while (true) {
                ...
                if (terminal.equalsIgnoreCase(LoginController.username + ":")) {
                    continue;
    ...
    public void send() {
        ...
        writer.println(LoginController.username + ": " + message);
        msgField.setText("");
